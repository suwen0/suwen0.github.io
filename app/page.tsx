...
import type { HomeDetailItem } from '@/components/home/HomeDetails';

interface ResearchInterestGroup {
  area: string;
  topics: string[];
}
...
interface SectionConfig {
  id: string;
  type: 'markdown' | 'publications' | 'list' | 'details';
  title?: string;
  source?: string;
...
function loadPageDataForLocale(locale: string | undefined): HomePageLocaleData {
  ...
  const aboutConfig = getPageConfig<{ profile?: { research_interests?: ResearchInterestGroup[] }; sections?: SectionConfig[] }>('about', locale);
